...
api: "POST https://boh.api.fire.rest/api/v1/public/vendors/{vendorId}/identity/suppliers/{supplierId}/archive"
description: "Soft-deletes a supplier. Archived suppliers no longer appear in listings by default."
authMethod: "none"
---
