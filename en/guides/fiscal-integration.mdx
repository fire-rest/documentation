...
<Note>
  Order compensation and the enrichment of these events are **being rolled out**. Today the
  numbering is obtained and stored; querying it by `orderCode` or `fiscalRequestId` already
  works.
</Note>
