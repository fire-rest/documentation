...
Today Fire emits four event types in production: [`order.completed`](/en/events/order-completed), [`order.cancelled`](/en/events/order-cancelled), [`fiscal.authorized.br`](/en/events/fiscal-authorized-br), and [`fiscal.cancelled.br`](/en/events/fiscal-cancelled-br).
