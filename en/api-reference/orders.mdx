...
<ParamField body="channel_uid" type="string" required>
  Unique identifier of the sales channel. Obtain from [GET /sales-channels](/en/api-reference/sales-channels).
</ParamField>

<ParamField body="channel" type="object" required>
  Sales channel details.
  <Expandable title="channel">
    <ParamField body="uid" type="string" required>Channel UID — same value as `channel_uid`.</ParamField>
    <ParamField body="name" type="string" required>
      Channel type name. One of: `POS`, `Kiosk`, `App`, `Web`, `CallCenter`, `Aggregator`.
    </ParamField>
...
<ParamField body="service_uid" type="string" required>
  Unique identifier of the fulfillment service. Obtain from the `services` array in [GET /sales-channels](/en/api-reference/sales-channels).
</ParamField>

<ParamField body="service" type="object" required>
  Fulfillment service details.
  <Expandable title="service">
    <ParamField body="uid" type="string" required>Service UID — same value as `service_uid`.</ParamField>
    <ParamField body="name" type="string" required>
      Fulfillment type. One of: `DELIVERY`, `TAKEAWAY`, `PICKUP`.
    </ParamField>
...
<ParamField body="device_uid" type="string">
  Unique identifier of the device that originated the order (e.g. kiosk terminal ID).
</ParamField>

<ParamField body="device" type="object">
  Device details. `null` for channels without a physical device.
  <Expandable title="device">
    <ParamField body="uid" type="string">Device UID — same value as `device_uid`.</ParamField>
    <ParamField body="name" type="string">Device display name (e.g. `Dispositivo 1`).</ParamField>
...
<ParamField body="operator" type="object">
  ...
  <Expandable title="operator">
    ...
    <ParamField body="session" type="string">Active session identifier.</ParamField>
