...
<ParamField body="metadata" type="object">
  Free-form bag for provider-specific extras (raw response, internal IDs, etc.). Not validated. It reaches the order and the events as `authority.providerMetadata`, as is and opaque — just like in the fiscal numbering. Absent or `{}` becomes `null`.
