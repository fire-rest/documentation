...
**[Procurement](/en/boh-api/procurement)** — new section. `PUT /procurement/par-levels` to upsert stock targets per item/store, and `GET /procurement/suggested-order` to retrieve recommended reorder quantities.
