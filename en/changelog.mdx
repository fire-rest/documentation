...
New section documenting the **account currency** setting. Each BOH account now has a default ISO 4217 currency (set in Admin → Account → Currency) used across procurement costs, supplier item prices, and reports.
