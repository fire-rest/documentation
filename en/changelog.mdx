...
<form action="https://buttondown.com/api/emails/embed-subscribe/fire-docs" method="post" target="_blank" style={{border: '1px solid rgb(128 128 128 / 0.25)', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '2.5rem'}}>
  ...
  <div style={{fontSize: '0.875rem', opacity: 0.8, marginTop: '0.25rem', marginBottom: '0.75rem'}}>Get an email whenever a new entry lands here — new events, breaking changes and API reference updates. One click to unsubscribe.</div>
  <div style={{display: 'flex', flexWrap: 'wrap', gap: '0.5rem'}}>
    ...
    <button type="submit" style={{padding: '0.5rem 1rem', borderRadius: '0.5rem', border: 'none', background: '#E6293D', color: '#fff', fontSize: '0.875rem', fontWeight: 600, cursor: 'pointer'}}>Subscribe</button>
  </div>
</form>
