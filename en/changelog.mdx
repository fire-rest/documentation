...
## 23 September 2026 — Catalog Agent user manual

New manual for anyone managing the catalog with the **Catalog Agent**, the AI chat that proposes product tags and applies them only with human approval.

- **[Catalog Agent](/en/manuals/backoffice/catalog-agent)** — how to chat or upload a file to tag products, which decisions the agent asks for (mode, new terms, aliases), and why an approval can come back partial when someone edits the product in the meantime.
