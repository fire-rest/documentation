...
import ChangelogSubscribe from '/snippets/changelog-subscribe.mdx';

<ChangelogSubscribe
  title="Subscribe to updates"
  body="Get an email whenever a new entry lands here — new events, breaking changes and API reference updates. One click to unsubscribe."
  placeholder="you@company.com"
  button="Subscribe"
/>

## 4 August 2026 — PIPELINE TEST, do not merge

This entry exists only to prove the newsletter workflow fires on a brand new
`## ` heading. It is removed before the PR leaves draft.

- A **table** to check the Markdown survives:

| Thing | State |
|---|---|
| [Relative link](/en/quickstart) | should become absolute |
| `inline code` | should stay |

<Note>
This callout should arrive as a blockquote.
</Note>
