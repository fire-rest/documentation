...
<Note>
  The turn-off does not reach the sales channels yet: today it is Fire's operational record of
  what stopped being sold, when and why. Channel propagation is the next stage.
</Note>
