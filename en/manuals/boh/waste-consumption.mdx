...
**Where you work:** **BOH → Movements** — **Waste events** (`/boh/admin/operations/waste-events`), **Internal consumption** (`/boh/admin/operations/internal-consumptions`), and the **Waste reasons** catalog (`/boh/admin/operations/waste-reasons`).
...
To add one: **Movements → Waste reasons → Create** (`/boh/admin/operations/waste-reasons/new`).
