...
Account-level (not per store):

- **[Fire credentials](/en/manuals/kds/fire-credentials)** — host and API key for fiscal print and cancel.
- **[Station categories](/en/manuals/kds/station-categories)** — `item_type` codes and product thumbs that routing mappings use.
...
| **Print on bump** | Store-wide comanda and/or fiscal on the print station. Arm the printer on the KDS screen. |

Next: [Set up a store](/en/manuals/kds/store-setup) · [Fire credentials](/en/manuals/kds/fire-credentials) · [Station categories](/en/manuals/kds/station-categories) · [Pair a kitchen device](/en/manuals/kds/device-pairing) · [Operator board](/en/manuals/kds/operator-board).
