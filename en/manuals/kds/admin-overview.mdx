...
For the day-to-day operator actions on the kitchen screen, see [Screen actions](/en/manuals/kds/screen-actions) and [Order display](/en/manuals/kds/waitlist).
...
| A physical screen (fire-kds) | Each KDS screen in the kitchen runs the **fire-kds** app with a **Device ID** that must match the one configured in the backoffice. |
...
Next: [Set up a store](/en/manuals/kds/store-setup).
