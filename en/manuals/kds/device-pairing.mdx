...
<Steps>
  ...
  <Step title="Confirm the device is ready">
    After a successful pair, the device opens the store **dashboard** on its own. You do not reload the page or type the code again. From the dashboard you can open the configured KDS screens, the order display, or the operator board.
  </Step>
</Steps>
