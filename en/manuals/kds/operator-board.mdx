...
| **Print fiscal invoice** | Fire Agent on this PC + store **Operator fiscal printer** | Reprints the fiscal slip. Not the kitchen ASSEMBLY printer. |

<Frame>
  <img src="/images/manuals/kds/operator-board/04-operator-actions.png" alt="Supervisor actions with confirmation dialog" />
</Frame>

## Operator fiscal printer

The printer icon opens **Operator fiscal printer**. Enable it, pick the Fire Agent queue on **this** computer, and test. Kitchen bump printing is a different printer on the KDS tablet or expo PC.

<Frame>
  <img src="/images/manuals/kds/operator-board/05-operator-fiscal-printer.png" alt="Operator fiscal printer modal with enable switch and printer list" />
</Frame>

<Warning>
  If Fire Agent is offline on the supervisor PC, reprint fails even when the kitchen printer works.
</Warning>
