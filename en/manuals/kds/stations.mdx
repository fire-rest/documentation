...
- **Item types no longer live on the station.** Saving a station **clears** legacy `item_types` / `exclude_item_types`. Which products hit the grill is decided only in [Routing](/en/manuals/kds/routing) and [Station categories](/en/manuals/kds/station-categories).

**When to use it:**

- **Production:** filter channels (e.g. hide delivery from the hot line).
