...
The order display opens in its own browser tab from the store dashboard, separate from the KDS operator screens. Open it on the device in the pickup area and leave it running full screen.
