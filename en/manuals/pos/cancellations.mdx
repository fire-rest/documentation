...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Session menu with the Cancel order option" />
</Frame>
...
The manager generates the code in the backoffice from **POS → Authorization Tokens**, with the cancellation purpose. The manager dictates it to the cashier, who types it on the keypad.

<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="POS screen asking for the manager code to access order cancellation" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="List of the current day's orders with status and the +30 min badge" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Cancellation confirmation with the optional reason field" />
</Frame>
