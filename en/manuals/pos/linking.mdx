...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Country and vendor selector in the backoffice" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Channel selector with Fire POS selected" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Store selector in the backoffice header" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="POS submenu with the Terminals option" />
</Frame>
...
1. In the top-right corner click **+ Create slot**.
   ...
   <Frame>
     <img src="/images/manuals/pos/coming-soon.svg" alt="Terminals page with the Create slot button" />
   </Frame>
...
2. **Create linking slot modal.** Verify the target store and choose how long the code is valid (default **30 minutes**). Click **Generate code**.
   ...
   <Frame>
     <img src="/images/manuals/pos/coming-soon.svg" alt="Create slot modal with the target store and the validity field" />
   </Frame>
...
3. The backoffice shows a **6-digit code** with its expiration time. Use the **Copy** button or write it down. The code is shown once and can be used to link a single device.
   ...
   <Frame>
     <img src="/images/manuals/pos/coming-soon.svg" alt="Generated 6-digit code with the copy button and the expiration time" />
   </Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="POS screen with the Link terminal title and the numeric keypad" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Numeric keypad with the 6 digits entered" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Cashier sign-in screen after linking the terminal" />
</Frame>
...
<Frame>
  <img src="/images/manuals/pos/coming-soon.svg" alt="Terminal list with the new device in ACTIVE status" />
</Frame>
