...
| Field | Type | Description |
|---|---|---|
| `productId` | string | Modifier option product this override applies to |
| `priceInfo` | object | Price override for this specific option on this product |
| `priceInfo.pointPrice` | number | Points price |
| `priceInfo.price` | number | Overridden price |
| `priceInfo.referencePrice` | number | Reference price |
| `priceInfo.suggestedPrice` | number | Suggested price |
