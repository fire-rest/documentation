...
| `listId` | string | Target list identifier, **same as the `list.listId` you received in [`menu.updated`](/en/webhook-reference/menu-updated)**. It's the correlation key between this event and the published menu |
...
[`menu.updated`](/en/webhook-reference/menu-updated), where the option travels as a product of type
...
[`menu.updated`](/en/webhook-reference/menu-updated#datamenuproductsn) / `product.updated`
...
[`menu.updated`](/en/webhook-reference/menu-updated).
...
That's why it's emitted just like in [`menu.updated`](/en/webhook-reference/menu-updated) —
...
[`data.menu.modifierGroups[n]`](/en/webhook-reference/menu-updated#datamenumodifiergroupsn) in
