...
| [`order.invoiced`](/en/events/order-invoiced) | Every country — the tax authority authorizes the order's fiscal document via your fiscal provider. The country travels in `fiscal.countryCode`. |
| [`order.reversed`](/en/events/order-reversed) | Every country — the tax authority confirms cancellation of a previously authorized fiscal document. The country travels in `fiscal.countryCode`. |
