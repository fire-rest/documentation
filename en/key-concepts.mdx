...
| [`order.invoiced`](/en/events/order-invoiced) | Brazil only — SEFAZ authorizes the order's fiscal document via your fiscal provider. |
| [`order.reversed`](/en/events/order-reversed) | Brazil only — SEFAZ confirms cancellation of a previously authorized fiscal document. |
