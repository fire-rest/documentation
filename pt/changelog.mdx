...
<Note>
  O desligamento ainda não chega aos canais de venda: hoje ele é o registro operacional do Fire
  sobre o que deixou de ser vendido, quando e por quê. A propagação para os canais é a próxima
  etapa.
</Note>
