...
{/*
  O formulário do próprio Buttondown, embutido num iframe.

  De propósito não segue o estilo do resto da página. O Buttondown bloqueia AJAX
  cross-origin, então um formulário nosso só consegue enviar mandando o leitor
  para buttondown.com. O iframe o mantém aqui E traz o captcha Turnstile e o
  firewall do Buttondown, que um formulário feito à mão pularia.

  Repetido igual em en/ e es/ — o embed não tem idioma próprio.
*/}
...
<div style={{border: '1px solid rgb(128 128 128 / 0.25)', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '2.5rem'}}>
  ...
  <iframe src="https://buttondown.com/fire-docs?as_embed=true" title="Assine as atualizações" style={{width: '100%', height: '175px', border: 'none', borderRadius: '0.5rem', marginTop: '0.75rem', colorScheme: 'light'}} />
</div>
