...
**[Compras](/pt/boh-api/procurement)** — nova seção. `PUT /procurement/par-levels` para upsert de metas de estoque por item/estabelecimento, e `GET /procurement/suggested-order` para obter quantidades de reabastecimento sugeridas.
