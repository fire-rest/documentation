...
Nova seção documentando a configuração de **moeda da conta**. Cada conta BOH agora tem uma moeda ISO 4217 padrão (definida em Admin → Account → Currency) usada em custos de abastecimento, preços de itens de fornecedor e relatórios.
