...
<ChangelogSubscribe
  title="Assine as atualizações"
  body="Receba um e-mail sempre que uma nova entrada for publicada — eventos novos, mudanças incompatíveis e atualizações da referência da API. Cancele com um clique."
