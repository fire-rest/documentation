...
| `listId` | string | Identificador da lista destino, **igual ao `list.listId` recebido em [`menu.updated`](/pt/webhook-reference/menu-updated)**. É a chave de correlação entre este evento e o menu publicado |
...
[`menu.updated`](/pt/webhook-reference/menu-updated), onde a opção viaja como produto do tipo
...
[`menu.updated`](/pt/webhook-reference/menu-updated#datamenuproductsn) / `product.updated`
...
[`menu.updated`](/pt/webhook-reference/menu-updated).
...
Por isso ele é emitido igual a [`menu.updated`](/pt/webhook-reference/menu-updated) — `price: 0`
...
[`data.menu.modifierGroups[n]`](/pt/webhook-reference/menu-updated#datamenumodifiergroupsn) em
...
em [`menu.updated`](/pt/webhook-reference/menu-updated).
