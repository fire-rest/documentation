...
## Passo 2: Buscar seus canais de venda

Se sua integração injeta pedidos, você precisa mapear os IDs de canal do Fire para os identificadores do seu agregador.
...
Coloque a lista de canais em cache e use-a para resolver o canal correto ao injetar pedidos.

Veja [Canais de venda](/pt/configuration/sales-channels) para o guia completo de mapeamento.
...
<CardGroup cols={2}>
  ...
  <Card title="Referência da API" icon="code" href="/pt/api-reference/introduction">
    Injetar pedidos e consultar canais de venda.
  </Card>
</CardGroup>
