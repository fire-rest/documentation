...
## Passo 5: Adicionar eventos fiscais

Se você tem emissão fiscal habilitada para uma loja, em qualquer país, adicione um segundo flow com trigger `order.invoiced` (e outro com `order.reversed`) para receber o contexto do documento fiscal. Use o mesmo endpoint HTTPS e o mesmo template; o país viaja em `fiscal.countryCode`.
