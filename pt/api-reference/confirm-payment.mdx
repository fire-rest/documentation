...
<Tip>
  Precisa corrigir o pedido antes de cobrá-lo —dados de faturamento do cliente, localizador—? Isso
  vai pelo [Corrigir pedido](/pt/api-reference/update-order), não por este endpoint. Este só
  registra o dinheiro; a diferença entre os dois está explicada lá.
</Tip>
...
```json 400 — a cobrança não atinge o total
{
  "success": false,
