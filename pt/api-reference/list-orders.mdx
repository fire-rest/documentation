...
sub-objeto `metadata` sempre tem o **mesmo formato amplo** — ele contém a união dos identificadores
de todos os países — mas **apenas os campos correspondentes a `fiscal.countryCode` são preenchidos;
os demais ficam `null`**. Leia `fiscal.countryCode` para saber quais identificadores esperar.
...
identificadores específicos de cada país abaixo são adicionados por cima; os identificadores dos
**outros** países estão presentes, mas com valor `null`.
...
<Tabs>
  <Tab title="Colombia (CO)">
    ```json metadata — CO (DIAN)
    {
      ...
      "claveAcceso": null, "numeroAutorizacion": null,
      "folio": null, "ted": null, "tipoDte": null, "trackId": null,
      "cae": null, "fechaVtoCae": null, "puntoVenta": null, "numeroComprobante": null, "tipoComprobante": null,
      "numeroControl": null, "numeroFactura": null, "rifEmisor": null,
      "chaveAcesso": null, "protocolo": null, "numero": null, "serie": null, "modelo": null, "cnpjEmitente": null
    }
    ```
  </Tab>
  <Tab title="Ecuador (EC)">
    ```json metadata — EC (SRI)
    {
      ...
      "cufe": null, "prefijo": null, "numeroDian": null,
      "folio": null, "ted": null, "tipoDte": null, "trackId": null,
      "cae": null, "fechaVtoCae": null, "puntoVenta": null, "numeroComprobante": null, "tipoComprobante": null,
      "numeroControl": null, "numeroFactura": null, "rifEmisor": null,
      "chaveAcesso": null, "protocolo": null, "numero": null, "serie": null, "modelo": null, "cnpjEmitente": null
