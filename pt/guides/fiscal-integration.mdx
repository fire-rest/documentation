...
<Note>
  A compensação do pedido e o enriquecimento destes eventos estão **em implementação**. Hoje a
  numeração é obtida e guardada; consultá-la por `orderCode` ou por `fiscalRequestId` já
  funciona.
</Note>
