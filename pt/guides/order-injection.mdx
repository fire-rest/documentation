...
| Campo | Descrição |
|---|---|
| `channel_id` | O ID do canal de venda do Fire (de webhooks de publicação como [`channel.updated`](/pt/webhook-reference/channel-updated) ou [Integrações de agregadores](/pt/configuration/backoffice-integrations)) |
