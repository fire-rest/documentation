...
<Tabs>
  <Tab title="v2.1 · atual">
    Você está vendo o contrato **atual (v2.1)** de `order.opened`. Este evento é **novo na v2.1** — não tem versão anterior. Nasceu com `data.policy` e `data.lastKnown` já no snapshot.
  </Tab>
</Tabs>
