...
| [`fiscal.authorized.br`](/pt/events/fiscal-authorized-br) | Apenas Brasil — a SEFAZ autoriza o documento fiscal do pedido via seu provedor fiscal. |
| [`fiscal.cancelled.br`](/pt/events/fiscal-cancelled-br) | Apenas Brasil — a SEFAZ confirma o cancelamento de um documento fiscal previamente autorizado. |
