...
| [`order.invoiced`](/pt/events/order-invoiced) | Todos os países — o órgão fiscal autoriza o documento fiscal do pedido via seu provedor fiscal. O país viaja em `fiscal.countryCode`. |
| [`order.reversed`](/pt/events/order-reversed) | Todos os países — o órgão fiscal confirma o cancelamento de um documento fiscal previamente autorizado. O país viaja em `fiscal.countryCode`. |
