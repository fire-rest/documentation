...
O Agente Fire é um agente local que permite que qualquer navegador (FIRE POS, XMART, fire-kds, etc.) imprima em impressoras térmicas de ponto de venda por WebSocket. Depois de instalado, ele roda em segundo plano e inicia automaticamente com o Windows.

Instale uma vez em cada dispositivo Windows que tenha uma impressora conectada. Tablets de cozinha no Android usam outro app: [Instalação no Android](/pt/manuals/fire-agent/android).

<Card title="Tablet Android do KDS" icon="mobile" href="/pt/manuals/fire-agent/android">
  APK do Agente Fire para o mesmo dispositivo que roda o fire-kds no Chrome.
</Card>
