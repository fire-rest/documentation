...
<Note>
  A impressão da cozinha no fire-kds tenta primeiro a URL da **plataforma detectada** (Windows versus Android / o resto) e **cai na outra** se essa conexão falhar. Você não escolhe a URL na tela do KDS.
</Note>
