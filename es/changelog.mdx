...
Nueva sección que documenta la configuración de **moneda de la cuenta**. Cada cuenta BOH ahora tiene una moneda ISO 4217 predeterminada (configurada en Admin → Account → Currency) que se usa en costos de abastecimiento, precios de ítems de proveedor y reportes.
