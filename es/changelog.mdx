...
{/*
  El formulario propio de Buttondown, embebido en un iframe.

  A propósito no sigue el estilo del resto de la página. Buttondown bloquea el
  AJAX cross-origin, así que un formulario nuestro solo puede enviarse mandando
  al lector a buttondown.com. El iframe lo deja acá Y suma el captcha Turnstile
  y el firewall de Buttondown, que un formulario a mano se saltearía.

  Repetido igual en en/ y pt/ — el embed no tiene idioma propio.
*/}
...
<div style={{border: '1px solid rgb(128 128 128 / 0.25)', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '2.5rem'}}>
  ...
  <iframe src="https://buttondown.com/fire-docs?as_embed=true" title="Suscríbete a las actualizaciones" style={{width: '100%', height: '175px', border: 'none', borderRadius: '0.5rem', marginTop: '0.75rem', colorScheme: 'light'}} />
</div>
