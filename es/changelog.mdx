...
**[Compras](/es/boh-api/procurement)** — nueva sección. `PUT /procurement/par-levels` para upsert de objetivos de stock por ítem/establecimiento, y `GET /procurement/suggested-order` para obtener cantidades de reorden sugeridas.
