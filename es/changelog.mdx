...
<Note>
  El apagado todavía no llega a los canales de venta: hoy es el registro operativo de Fire sobre
  qué se dejó de vender, cuándo y por qué. La propagación a los canales es la próxima etapa.
</Note>
