...
Sigue siendo el contrato **v1** — todo lo agregado es retrocompatible (bloques nuevos
sobre un shape existente). Nada de esto cambia un campo que ya estés leyendo.
