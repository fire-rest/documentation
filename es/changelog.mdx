...
<ChangelogSubscribe
  ...
  body="Recibe un correo cada vez que se publica una entrada nueva — eventos nuevos, cambios incompatibles y actualizaciones de la referencia de API. Puedes darte de baja con un clic."
