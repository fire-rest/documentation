...
## 23 de septiembre de 2026 — Manual del Agente de catálogo

Nuevo manual para quien opera el catálogo con el **Agente de catálogo**, el chat con inteligencia artificial que propone etiquetas de producto y las aplica solo con aprobación humana.

- **[Agente de catálogo](/es/manuals/backoffice/catalog-agent)** — cómo conversar o subir un archivo para etiquetar productos, qué decisiones pide el agente (modo, términos nuevos, alias) y por qué una aprobación puede terminar parcial cuando alguien edita el producto en el medio.
