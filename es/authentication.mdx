...
Cuando registres tu endpoint de webhook en el dashboard de Fire en **Settings → Endpoints**, Fire mostrará el secret del webhook para ese endpoint. Cópialo y guárdalo de forma segura en tu sistema — lo necesitarás para verificar cada petición entrante.
