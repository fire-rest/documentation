...
<Note>
  La impresión de cocina desde fire-kds prueba primero la URL de la **plataforma detectada** (Windows frente a Android / el resto) y **cae a la otra** si esa conexión falla. No eliges la URL en la pantalla KDS.
</Note>
