...
- Un navegador compatible: Chrome o Edge 105+, Brave, Opera o Firefox 110+. Ver [requisitos del terminal](/es/manuals/pos/hardware-requirements#navegador).
...
<Note>
  La impresión de cocina desde fire-kds prueba primero la URL de la **plataforma detectada** (Windows `wss://localhost:9101` frente a Android `wss://kds-agent.fire.rest:9101`) y **cae a la otra** si esa conexión falla. No eliges la URL en la pantalla KDS. Tablets: [Instalación en Android](/es/manuals/fire-agent/android).
</Note>
