...
El Agente Fire es un agente local que permite que cualquier navegador (FIRE POS, XMART, fire-kds, etc.) imprima en impresoras térmicas de punto de venta a través de WebSocket. Una vez instalado, se ejecuta en segundo plano y arranca automáticamente con Windows.

Instálalo una vez por cada equipo Windows que tenga una impresora conectada. Las tablets de cocina en Android usan otra app: [Instalación en Android](/es/manuals/fire-agent/android).

<Card title="Tablet Android del KDS" icon="mobile" href="/es/manuals/fire-agent/android">
  APK del Agente Fire para el mismo dispositivo que corre fire-kds en Chrome.
</Card>
