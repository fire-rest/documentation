...
<Tabs>
  <Tab title="v2.1 · actual">
    Estás viendo el contrato **actual (v2.1)** de `order.opened`. Este evento es **nuevo en v2.1** — no tiene versión anterior. Nació con `data.policy` y `data.lastKnown` ya en el snapshot.
  </Tab>
</Tabs>
