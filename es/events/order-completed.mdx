...
<Tabs>
  <Tab title="v1.2 · actual">
    Estás viendo el contrato **actual (v1.2)** de `order.completed`. **v1.2 agrega** `data.fiscalRepresentation`: la numeración fiscal que el punto de venta obtuvo antes de inyectar la orden. Se **omite** cuando la venta no se numeró, y su presencia **no** significa que el comprobante esté autorizado. Solo aditivo — nada de lo que ya leías cambió.
  </Tab>
