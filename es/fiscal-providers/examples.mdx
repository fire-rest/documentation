...
- **`establecimiento` y `puntoEmision` van separados**, como los define el SRI. FIRE compone
  el número visible `005-004-000000052` con las tres piezas, sin suponer dónde se parte.
