...
| [`order.invoiced`](/es/events/order-invoiced) | Todos los países — el ente fiscal autoriza el documento fiscal de la orden vía tu proveedor fiscal. El país viaja en `fiscal.countryCode`. |
| [`order.reversed`](/es/events/order-reversed) | Todos los países — el ente fiscal confirma la cancelación de un documento fiscal previamente autorizado. El país viaja en `fiscal.countryCode`. |
