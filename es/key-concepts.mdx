...
| [`fiscal.authorized.br`](/es/events/fiscal-authorized-br) | Solo Brasil — SEFAZ autoriza el documento fiscal de la orden vía tu proveedor fiscal. |
| [`fiscal.cancelled.br`](/es/events/fiscal-cancelled-br) | Solo Brasil — SEFAZ confirma la cancelación de un documento fiscal previamente autorizado. |
