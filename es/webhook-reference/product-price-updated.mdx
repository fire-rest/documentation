...
| `listId` | string | Identificador de la lista destino, **igual al `list.listId` que recibiste en [`menu.updated`](/es/webhook-reference/menu-updated)**. Es la llave de correlación entre este evento y el menú publicado |
...
[`menu.updated`](/es/webhook-reference/menu-updated), donde la opción viaja como producto de tipo
...
[`menu.updated`](/es/webhook-reference/menu-updated#datamenuproductsn) / `product.updated`
...
[`menu.updated`](/es/webhook-reference/menu-updated).
...
Por eso se emite igual que en [`menu.updated`](/es/webhook-reference/menu-updated) — `price: 0`
...
[`data.menu.modifierGroups[n]`](/es/webhook-reference/menu-updated#datamenumodifiergroupsn) en
