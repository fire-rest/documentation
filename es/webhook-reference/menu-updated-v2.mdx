...
| `priceInfo` | object | Override de precio para esta opción específica en este producto |
| `priceInfo.pointPrice` | number | Precio en puntos |
| `priceInfo.price` | number | Precio con override |
| `priceInfo.referencePrice` | number | Precio de referencia |
| `priceInfo.suggestedPrice` | number | Precio sugerido |
