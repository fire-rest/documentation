---
title: "Archivar un establecimiento"
api: "POST https://boh.api.fire.rest/api/v1/public/vendors/{vendorId}/identity/stores/{storeId}/archive"
description: "Eliminación lógica de un establecimiento. Los establecimientos archivados no aparecen en listados por defecto."
authMethod: "none"
---
