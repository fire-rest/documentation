...
## Paso 2: Obtener tus canales de venta

Si tu integración inyecta órdenes, necesitas mapear los IDs de canal de Fire con los identificadores de tu agregador.
...
Cachea la lista de canales y úsala para resolver el canal correcto al inyectar órdenes.

Consulta [Canales de venta](/es/configuration/sales-channels) para la guía completa de mapeo.
...
<CardGroup cols={2}>
  ...
  <Card title="Referencia API" icon="code" href="/es/api-reference/introduction">
    Inyectar órdenes y consultar canales de venta.
  </Card>
</CardGroup>
