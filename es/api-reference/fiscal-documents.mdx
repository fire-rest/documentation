...
<ResponseField name="document" type="object">
  ...
  <Expandable title="document">
    ...
    <ResponseField name="documentNumber" type="string">
      Número visible, compuesto según la convención del país (`001-020-000000123`). Es para
      **imprimir**: para buscar o conciliar usá los identificadores de `countryData`.
    </ResponseField>
...
<Tabs>
  <Tab title="Ecuador (EC) · disponible">
    ...
    <Note>
      **`documentNumber` no está acá porque no lo emite el SRI.** Lo compone Fire con estas
      piezas —`establecimiento-puntoEmision-secuencial`— para que puedas imprimirlo sin conocer
      la convención del país.
    </Note>
  </Tab>
