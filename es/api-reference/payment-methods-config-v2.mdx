      ...
      <Expandable title="store">
        ...
        <ResponseField name="methods" type="object[]">
          <Expandable title="storeMethod">
            ...
            <ResponseField name="code" type="string">Código, por comodidad. Para identificar, usa `methodId`.</ResponseField>
...
- Un vendor pertenece a un país, pero sus tiendas se leen por el país que cada una tiene cargado.
  ...
  identificarlo**: dos países pueden definir el mismo código con `id` distinto. Indexar de tu lado
  por `code` funciona hasta el día en que el cliente abre en un segundo país.
