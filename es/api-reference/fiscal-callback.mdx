...
La forma requerida del campo `document` depende del `countryCode`. Todas las variantes comparten campos base (`docType`, `docSubtype`) más identificadores específicos del país requeridos por esa autoridad.
