...
description: "Lee una orden puntual por cualquiera de sus referencias, con projection de campos. La orden debe pertenecer al account y vendor de tu API key."
authMethod: "bearer"
---
...
```json 200 — una orden que todavía se está cobrando (fields=orderCode,status,settlement,payments)
{
  "orderCode": "OC-1024",
  "status": "OPEN",
  "settlement": {
...
```json 409 — la referencia matchea más de una orden
{
  "success": false,
  "error": "CONFLICT",
