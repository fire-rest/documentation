...
<Tip>
  ¿Tenés que corregir la orden antes de cobrarla —datos de factura del cliente, localizador—? Eso
  va por [Corregir orden](/es/api-reference/update-order), no por este endpoint. Este solo registra
  la plata; la diferencia entre los dos está explicada ahí.
</Tip>
