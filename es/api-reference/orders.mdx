...
<ParamField body="payments" type="object" required>
  ...
  <Expandable title="payments">
    ...
    <ParamField body="shippingCost" type="object[]">
      Líneas de costo de envío. Cada entrada usa la **misma forma de tramo de precio** que `totals[]`: moneda, subtotales, descuentos, porcentajes de impuesto y total de la línea.
    ...
    <ParamField body="discounts" type="object[]">
      Líneas de descuento: cada fila es un descuento aplicado con los **mismos campos de tramo de precio** que `totals[]` y `shippingCost[]` (importes, porcentaje y valor de descuento, impuestos, total).
