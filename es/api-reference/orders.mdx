  ...
  <Expandable title="payments">
    ...
    <ParamField body="discounts" type="object[]">
      ...
      <Expandable title="discounts[n]">
        <ParamField body="code" type="string">Identificador del tipo de descuento. Ejemplos: `FIXED` (importe fijo), `PERCENTAGE` (porcentaje), `KEETA_DISCOUNT` (promoción específica de plataforma). Se acepta cualquier string.</ParamField>
        <ParamField body="currencyCode" type="string">Código de moneda ISO 4217.</ParamField>
