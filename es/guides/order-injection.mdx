...
| Campo | Descripción |
|---|---|
| `channel_id` | El ID del canal de venta de Fire (de webhooks de publicación como [`channel.updated`](/es/webhook-reference/channel-updated) o [Integraciones de agregadores](/es/configuration/backoffice-integrations)) |
